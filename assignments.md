...
* <span style = 'background-color:yellow'>[Research Proposal]({{ site.baseurl }}/data/hw/Proposal.pdf) (Due: Monday, 10/10/17, by 9:00 AM; submit through [Blackboard](http://easternct.blackboard.com))</span>
{% comment %}
